              ...
              >
                ...
                <div className="flex flex-col items-center text-center">
                  <div className={`p-3 rounded-full mb-3 ${
                    isDragActive ? 'bg-indigo-100 text-indigo-600 dark:bg-indigo-800 dark:text-indigo-300' :
                    isDragReject ? 'bg-red-100 text-red-600 dark:bg-red-800 dark:text-red-300' :
